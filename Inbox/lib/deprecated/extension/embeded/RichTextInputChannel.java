package com.example.Inbox.extension.embeded;
...
/**
 * {@link } is a platform channel between Android and Flutter that is used to
 ...
 * }.
 *
 * <p>{@link } comes with a default {@link
 ...
 * messages.
 */
public class RichTextInputChannel extends TextInputChannel {
    private static final String TAG = "RichTextInputChannel";
    ...
    private final MethodChannel.MethodCallHandler parsingMethodHandler =
            new MethodChannel.MethodCallHandler() {
                ...
                public void onMethodCall(@NonNull MethodCall call, @NonNull MethodChannel.Result result) {
                    ...
                    switch (method) {
                        case "RichTextInput.show":
                            textInputMethodHandler.show();
                            result.success(null);
                            break;
                        case "RichTextInput.hide":
                            textInputMethodHandler.hide();
                            result.success(null);
                            break;
                        case "RichTextInput.setClient":
                            try {
                            ...
                            break;
                        case "RichTextInput.requestAutofill":
                            textInputMethodHandler.requestAutofill();
                            result.success(null);
                            break;
                        case "RichTextInput.setPlatformViewClient":
                            final int id = (int) args;
                            textInputMethodHandler.setPlatformViewClient(id);
                            break;
                        case "RichTextInput.setEditingState":
                            try {
                            ...
                            break;
                        case "RichTextInput.setEditableSizeAndTransform":
                            try {
                            ...
                            break;
                        case "RichTextInput.clearClient":
     ...
     */
    public RichTextInputChannel(@NonNull DartExecutor dartExecutor) {
        super(dartExecutor);
...
//    }
    ...
    public static class TextEditState extends TextInputChannel.TextEditState {
        ...
        public TextEditState(@NonNull String text, int selectionStart, int selectionEnd) {
            super(text, selectionStart, selectionEnd);
            this.text = text;
