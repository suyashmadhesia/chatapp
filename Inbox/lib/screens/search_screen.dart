...
//Functions
  ...
  handleSearch(String value){
    Future<QuerySnapshot> users = usersRef.where('username', isGreaterThanOrEqualTo: value).get();
    setState(() {
      searchResult = users;
    });
  ...
  AppBar buildSearchField(){
    return AppBar(
      ...
      title: TextFormField(
        ...
        FilteringTextInputFormatter(RegExp('[a-z0-9_]'), allow: true)//RegEx for  only correct input taken 
      ],
        style: TextStyle(color: Colors.grey[700], fontFamily: 'Montserrat', fontSize: 14.0),
      ...
      child: Center(
        child: ListView(
          ...
          children: [
            ...
            Center(child: Text('Search with exact username...',style: TextStyle(color: Colors.grey, fontSize: 14, fontFamily: 'Mulish'))),
          ],
        ),
        ),
      );
        ...
        GestureDetector(
          onTap: () {
              ...
              if(user.userId == userid){
               currentUserProfile(context, profileId: currentUser.uid);
              //  Navigator.push(
              //                           context,
              //                           MaterialPageRoute(
              //                               builder: (context) =>
